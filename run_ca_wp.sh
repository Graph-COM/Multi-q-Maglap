gpu=0
data_name='distance/16to63_64to71_72to83_ca_wp'
...
#python main.py --pe maglap --pe_dim 32 --q_dim 10 --gpu_id $gpu --q 0.05 --base_gnn $base_gnn --seed $seed --dataname $data_name --out_dim 5 --batch_size 128
