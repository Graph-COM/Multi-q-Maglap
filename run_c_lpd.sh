gpu=0
data_name='distance/16to63_64to71_72to83_c_lpd'
base_gnn='none_e'
#base_gnn='none'
...
#python main.py --pe maglap --pe_dim 32 --q_dim 10 --gpu_id $gpu --batch_size 32 --q 0.05 --base_gnn $base_gnn --seed $seed --dataname $data_name
